export type { IDragBlockData } from 'src/types/type-models/type-drag-block';
export type { IAnswerData, IAnswerCreateMethods, IAnswerRelations } from 'src/types/type-models/type-answer';
